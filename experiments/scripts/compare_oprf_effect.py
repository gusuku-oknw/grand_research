...
Runs two configs on `tests/fixtures` (by default) and plots add/query latency.
This is a lightweight proxy to visualize overhead—not a full COCO benchmark.

Usage:
    python experiments/scripts/compare_oprf_effect.py
"""
...
def main() -> None:
    images_dir = Path("tests/fixtures")
    ...
    summary_dir = Path("output/compare_oprf_effect")
    ...
    configs = [
        RunConfig(
            ...
            shares_dir=Path("output/compare_baseline_shares"),
            meta_dir=Path("output/compare_baseline_meta"),
            recon_dir=Path("output/compare_baseline_recon"),
        ),
        RunConfig(
            name="voprf_padded",
            use_oprf=True,
            ...
            shares_dir=Path("output/compare_voprf_shares"),
            meta_dir=Path("output/compare_voprf_meta"),
            recon_dir=Path("output/compare_voprf_recon"),
        ),
    ]
