...
\caption{pHash 整合ダミー生成の流れ（符号抽出→低周波強調→32$\times$32 空間）}
...
図\ref{fig:resume-prec} と図\ref{fig:resume-time} に，オリジナルのみの精度と時間の要約を示す．

\begin{figure}[t]
\centering
\includegraphics[width=0.95\linewidth]{precision_summary.png}
\caption{検索精度（オリジナルのみ，plain vs dummy\_k1）}
\label{fig:resume-prec}
\end{figure}
