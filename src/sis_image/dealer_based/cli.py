...
def build_parser() -> argparse.ArgumentParser:
    ...
    workflow.add_argument("--recon_dir", type=str, default="output/recon_out")
    workflow.add_argument("--shares_dir", type=str, default="output/img_shares")
    workflow.add_argument("--meta_dir", type=str, default="output/img_meta")
    ...
    store.add_argument("--shares_dir", type=str, default="output/img_shares")
    store.add_argument("--meta_dir", type=str, default="output/img_meta")
    store.add_argument("--recon_dir", type=str, default="output/recon_out")
