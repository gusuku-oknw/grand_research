...
\newcommand{\studentname}{玉城洸弥}
\newcommand{\studentid}{1213033903}
\newcommand{\advisor}{\UTF{6DF8}水 恒輔}
...
\begin{enumerate}
  \item \textbf{視覚情報の漏えい}: pHash 整合ダミーは高周波をノイズ化するため PSNR は 10 dB 台まで低下し，視覚情報は大きく失われる．したがって内容の逆推定は本研究の評価範囲では困難と考えられる．
