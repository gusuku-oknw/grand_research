...
複数の秘密を復元できるようにアクセス構造を設計する\cite{tassa2007hierarchical,benaloh1988generalized}．
また，progressive（段階的）な復元を扱う系譜では，シェアの増加に伴って復元画像の品質が徐々に向上すること自体を目的とする研究がある\cite{jin2005progressive_color,liu2015visual_crypto_book}．
...
\emph{Journal of Cryptology}, 2007.

\bibitem{benaloh1988generalized}
J.~Benaloh and J.~Leichter,
``Generalized secret sharing and monotone functions,''
in \emph{Advances in Cryptology---CRYPTO '88 (LNCS)}, 1988.

\bibitem{jin2005progressive_color}
J.~Jin, W.~Q.~Yan, and M.~S.~Kankanhalli,
``Progressive color visual cryptography,''
\emph{Journal of Electronic Imaging}, 2005.

\bibitem{liu2015visual_crypto_book}
F.~Liu and W.~Q.~Yan (eds.),
\emph{Visual Cryptography for Image Processing and Security},
Springer, 2015.
