...
Usage:
  python scripts/plot_oprf_padding_coco.py \
    --baseline metrics_baseline.csv \
    --oprf metrics_voprf.csv \
    --output evaluation/figures/oprf_padding_coco
"""
...
def main() -> None:
    ...
    ap.add_argument("--output", type=Path, default=Path("evaluation/figures/oprf_padding_coco"))
    args = ap.parse_args()
